    ...
    ElemConstructor* construct, ElemDestructor* destroy, ElemCopy* copy)
{
    ...
    _DoublyListBase_Create(self, elem_size, construct, destroy, copy);
    return self;
}
...
#define _DLIST_IMPL_EX1(T, CONSTRUCT, DESTROY, COPY)                                               \
                                                                                                   \
    ...
    {                                                                                              \
        ...
        _DoublyListBase_Create((_DoublyListBase*)self, sizeof(T), CONSTRUCT, DESTROY, COPY);       \
        self->vptr = (void*)&vt;                                                                   \
    }                                                                                              \
                                                                                                   \
...
#define _DLIST_IMPL_EX2(T, CONSTRUCT, DESTROY, COPY)  _DLIST_IMPL_EX1(T, CONSTRUCT, DESTROY, COPY)
#define _DLIST_IMPL_EX3(T, CONSTRUCT, DESTROY, COPY)  _DLIST_IMPL_EX2(T, CONSTRUCT, DESTROY, COPY)
#define DLIST_IMPL_EX(T, CONSTRUCT, DESTROY, COPY)    _DLIST_IMPL_EX3(T, CONSTRUCT, DESTROY, COPY)

/* For POD types: NULL callbacks → memcpy-based */
#define DLIST_IMPL(T)  DLIST_IMPL_EX(T, NULL, NULL, NULL)
...
DLIST_IMPL_EX(String, _String_Create, _String_Destroy, _String_Copy);
